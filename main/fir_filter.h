...
extern float fir_input_left[BUFFER_SIZE / 2];
extern float fir_input_right[BUFFER_SIZE / 2];
extern float fir_output_left[BUFFER_SIZE / 2];
extern float fir_output_right[BUFFER_SIZE / 2];
